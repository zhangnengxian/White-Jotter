...
CREATE TABLE `admin_menu`  (
  ...
  `path` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `icon_cls` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `component` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `admin_permission`  (
  ...
  `desc_` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `admin_role`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `name_zh` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `admin_user_role` VALUES (4, 15, 1);
INSERT INTO `admin_user_role` VALUES (5, 15, 2);
INSERT INTO `admin_user_role` VALUES (6, 15, 3);
...
CREATE TABLE `book`  (
  ...
  `author` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  `date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  `press` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  `abs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '7bb912eab60fb6898268467ee57532c1', 'NfZ9lLKHaslOd5k+tYL4nA==', '管理员', '11122223333', 'evan_nightly@163.com', 1);
INSERT INTO `user` VALUES (2, 'test', '7bb912eab60fb6898268467ee57532c1', 'NfZ9lLKHaslOd5k+tYL4nA==', '测试', '44455556666', NULL, 1);
INSERT INTO `user` VALUES (3, 'editor', '7bb912eab60fb6898268467ee57532c1', 'NfZ9lLKHaslOd5k+tYL4nA==', '编辑', NULL, NULL, 1);
INSERT INTO `user` VALUES (15, 'zhangnx', '7bb912eab60fb6898268467ee57532c1', 'NfZ9lLKHaslOd5k+tYL4nA==', '张能先', '15685604100', '1655658911@qq.com', 1);
